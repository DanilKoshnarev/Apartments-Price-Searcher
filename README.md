...
# Apartments Price Searcher:  Бот для аналізу цін на квартири
...
- **di/container.py** — Контейнер для управління залежностями.
- **main.py** — Основний файл, точка входу в програму.
...
2. **Переконайтеся, що у вас встановлений Python версії 3.7 або вище.**
3. **Відкрийте термінал і перейдіть до директорії проекту.**
4. **Запустіть файл main.py командою:**
    ```bash
    python main.py
    ```
5. **Слідуйте підказкам у консолі для взаємодії з ботом.**
